...
[_QW] = { /* Qwerty */
  ...
  {KC_LCTL, KC_LGUI, KC_LALT, TG(_LW1), TG(_LW2), KC_SPC, KC_SPC, MO(_RS2), MO(_RS1), KC_CAPS, M(0),  KC_DELT}
},
[_CM] = { /* Colemak */
...
[_LW2] = { /* LOWER 2 */
  ...
  {KC_LCTL, KC_TRNS, KC_LALT, KC_TRNS, KC_TRNS, RESET,   RESET,   KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,  KC_PSCR}
}
};
