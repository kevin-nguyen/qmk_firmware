...
[_QW] = { /* Qwerty */
  ...
  {CTL_T(KC_PGDN), KC_LGUI, ALT_T(KC_HOME), KC_DEL,  F(10), KC_SPC,   KC_SPC,  F(9), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
[_CM] = { /* Colemak */
  ...
  {CTL_T(KC_PGDN), KC_LGUI, ALT_T(KC_HOME), KC_DEL,  F(10), KC_SPC,    KC_SPC,  MO(_RS), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
[_DV] = { /* Dvorak */
